...
![课堂PPT截图，Cahn–Hilliard 方程的线性稳定性分析。通过对均匀态的小扰动进行线性化与傅里叶分析，得到色散关系 σ(q)=-Λ(c̄)q²[f''(c̄)+κq²]。当 f''(c̄)<0 时，存在不稳定波数区间并由 q_max 选定早期结构尺度；当 f''(c̄)>0 时，均匀态线性稳定，微小扰动全部衰减。](https://files.mdnice.com/user/129153/7c10e96b-2598-4b14-b4fd-87ce0b2ad68b.png)
...
![课堂板书截图，右图展示自由能双势阱结构，黄色竖线表示体系平均浓度 c̄ 位于局部稳定但非全局极小的位置，对应亚稳态；左图示意在此背景下形成的有限尺寸液滴，其形成需克服由界面张力 γ 引入的自由能垒。](assets/images/15_003_c7b5cac1-313a-48ed-b49a-b8a207254231.png)
...
示意在亚稳态母相中形成半径为 R 的球形液滴时，总自由能变化 ΔF(R) 的典型形状。随 R 增大，表面自由能项随 R² 增长，代表界面张力带来的能量成本；体积自由能项随 -R³ 增长，代表液滴内部转入稳定相所获得的体相自由能收益。两者竞争导致 ΔF(R) 在某一半径 Rc 处达到极大值，对应成核势垒：当 R<Rc 时液滴趋于回缩消失，而当 R>Rc 时体积收益占优，液滴将自发生长并触发相分离过程。](assets/images/15_004_ebfbc92b-04f5-4752-bb4b-0328e09dbdb6.png)
