...
![平衡态与非平衡态界面张力机制的对。(d) 经典相分离（Cahn-Hilliard 机理）：在液态混合物中，界面曲率（κ）导致局部化学势（δμ）升高（吉布斯-汤姆逊效应）。这种能量上的不利驱动粒子流向低曲率区域，从而拉直界面，表现为热力学表面张力。(e) 活性反应-扩散系统（McRD 机理）：在质量守恒的活性系统中，并不存在显式的能量泛函。然而，界面的弯曲改变了膜上蛋白质“附着区”与“脱附区”的相对面积比。凸起的界面会导致脱附区增大，打破局部的反应平衡，从而产生净物质流。这种由几何曲率诱导的反应通量在宏观上涌现为一种“有效界面张力”，其动力学效果与经典表面张力高度一致。源自：Weyer, H., Roth, T.A. & Frey, E. Protein pattern morphology and dynamics emerging from effective interfacial tension. Nat. Phys. (2025).](assets/images/12_005_8ffdde23-b983-4b3e-a765-b731b2ce59e7.png)
