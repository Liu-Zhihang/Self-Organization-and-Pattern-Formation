...
![从微观晶格模型到宏观连续场论的粗粒化过程示意图。宏观连续介质，不再区分单个粒子，而是用一个均匀的颜色（灰色/混合色）代表局域体积分数 φ。箭头表示粗粒化（Coarse-graining）和平均操作 ⟨σᵢ⟩ → φ。图源：作者自绘](assets/images/13_003_2e3fad34-6173-48d9-9e59-d1a50b0e87af.png)
...
![自由能的分解图。开口向上的U型曲线代表熵项（-TS），开口向下的倒U型曲线代表能量项（E），以及两者叠加后的总自由能曲线，当 χ > 2 时，中间部分会隆起，形成标志性的双势阱（Double Well）结构，意味着相分离的发生。图源，作者自绘](assets/images/13_004_84477c25-3a46-4d96-91f6-01acf987cfd5.png)
...
![课堂PPT截图，自由能密度 f(φ) 随 Flory-Huggins 参数 χ 的变化](assets/images/13_005_4c738ba6-632a-4848-970b-94009e669640.png)
