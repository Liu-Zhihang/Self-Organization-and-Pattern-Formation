...
![Schematic diagram of coarse-graining process from microscopic lattice model to macroscopic continuous field theory. Macroscopic continuous medium no longer distinguishes individual particles but uses a uniform color (gray/mixed) to represent local volume fraction $\phi$. Arrow indicates coarse-graining and averaging operation $\langle \sigma_i \rangle \to \phi$. Source: Author's illustration](../cn/assets/images/13_003_2e3fad34-6173-48d9-9e59-d1a50b0e87af.png)
...
![Free energy decomposition diagram. Upward-opening U-shaped curve represents entropy term (-TS), downward-opening inverted U-shaped curve represents energy term (E), and the total free energy curve after superposition of both. When $\chi > 2$, the middle part bulges upward, forming the characteristic double-well structure, signifying phase separation occurrence. Source: Author's illustration](../cn/assets/images/13_004_84477c25-3a46-4d96-91f6-01acf987cfd5.png)
...
![Lecture Slide Screenshot, Free energy density $f(\phi)$ variation with Flory-Huggins parameter $\chi$](../cn/assets/images/13_005_4c738ba6-632a-4848-970b-94009e669640.png)
